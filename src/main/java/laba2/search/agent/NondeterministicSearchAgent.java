package laba2.search.agent;

import java.util.Optional;
import java.util.function.BiFunction;
import java.util.function.Function;

import laba2.agent.Agent;
import laba2.agent.Notifier;
import laba2.agent.impl.SimpleAgent;
import laba2.search.nondeterministic.AndOrSearch;
import laba2.search.nondeterministic.NondeterministicProblem;
import laba2.search.nondeterministic.Plan;
