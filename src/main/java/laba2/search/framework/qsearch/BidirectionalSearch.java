package laba2.search.framework.qsearch;
...
import laba2.search.framework.problem.BidirectionalProblem;
...
public class BidirectionalSearch<S, A> extends QueueSearch<S, A> {
	 ...
	 *
	 * @param problem a bidirectional search problem
	 * @param frontier the data structure to be used to decide which node to be
	 * expanded next
