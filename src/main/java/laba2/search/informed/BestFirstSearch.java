...
import laba2.search.framework.QueueBasedSearch;
import laba2.search.framework.QueueFactory;
import laba2.search.framework.qsearch.QueueSearch;
...
public class BestFirstSearch<S, A> extends QueueBasedSearch<S, A> implements Informed<S, A> {
	 ...
	 * evaluation function.
	 *
	 * @param impl A search execution strategy.
	 * @param evalFn An evaluation function, which returns a number purporting to
