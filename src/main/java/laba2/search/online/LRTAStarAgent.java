...
import laba2.search.framework.problem.OnlineSearchProblem;
import laba2.util.datastructure.TwoKeyHashMap;
...
public class LRTAStarAgent<P, S, A> extends SimpleAgent<P, A> {
	 ...
	 * given Percept.
	 * @param h heuristic function <em>h(s)</em>, which estimates the cost of
