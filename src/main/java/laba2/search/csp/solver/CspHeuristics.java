package laba2.search.csp.solver;
...
import laba2.search.csp.Assignment;
import laba2.search.csp.CSP;
import laba2.search.csp.Constraint;
...
public class CspHeuristics {
	...
	public static <VAR extends Variable, VAL> VariableSelectionStrategy<VAR, VAL> mrv() {
		return new MrvHeuristic<>();
	}

	public static <VAR extends Variable, VAL> VariableSelectionStrategy<VAR, VAL> deg() {
		return new DegHeuristic<>();
	}
	...
	public static <VAR extends Variable, VAL> ValueOrderingStrategy<VAR, VAL> lcv() {
		return new LcvHeuristic<>();
	}
