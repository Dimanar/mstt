...
public class GeneticAlgorithmForNumbers extends GeneticAlgorithm<Double> {
	 ...
	 * Constructor.
	 *
	 * @param individualLength vector length used for the representations of individuals. Use
	 * 1 for analysis of functions f(x).
	 * @param min minimal value to be used in vector elements.
	 * @param max maximal value to be used in vector elements.
