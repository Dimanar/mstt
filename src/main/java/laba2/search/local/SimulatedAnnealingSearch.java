...
import laba2.search.framework.NodeFactory;
import laba2.search.framework.SearchForActions;
import laba2.search.framework.SearchForStates;
import laba2.search.framework.SearchUtils;
...
public class SimulatedAnnealingSearch<S, A> implements SearchForActions<S, A>, SearchForStates<S, A> {
	 ...
	 *
	 * @param energyFn a function mapping nodes to the energy of their state (the lower the better).
	 */
