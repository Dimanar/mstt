package laba2.agent.impl.aprog;

import java.util.Optional;
import java.util.Set;

import laba2.agent.AgentProgram;
import laba2.agent.Model;
import laba2.agent.impl.DynamicState;
import laba2.agent.impl.aprog.simplerule.Rule;
...
public abstract class ModelBasedReflexAgentProgram<P, A> implements AgentProgram<P, A> {
	 ...
	 *
	 * @param rules a set of condition-action rules
	 */
