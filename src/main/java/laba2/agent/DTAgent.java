...
import laba2.probability.BeliefState;
...
public abstract class DTAgent extends SimpleAgent {
	...
	/**
	 * @param action_description permissible action descriptions
	 * @param belief_state current belief state of the agent about the world
