...
public class MixedRadixNumber extends Number {
	 ...
	 * array of radices.
	 *
	 * @param value the value of the mixed radix number
	 * @param radices the radices used to represent the value of the mixed radix
	 * number
	 */
	 ...
	 *
	 * @param radixValues the numerals of the mixed radix number
	 * @param radices the radices of the mixed radix number
	 */
	 ...
	 * @throws IllegalArgumentException if any of the specified numerals is less than zero, or if any
	 ...
	 *
	 * @param atPosition the position of the numeral to return
	 ...
	 * radices.
	 *
	 * @throws IllegalArgumentException if no radices are defined, if any radix is less than two, or
