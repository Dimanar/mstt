...
import laba2.util.math.geom.shapes.Circle2D;
import laba2.util.math.geom.shapes.Ellipse2D;
import laba2.util.math.geom.shapes.IGeometric2D;
import laba2.util.math.geom.shapes.Line2D;
import laba2.util.math.geom.shapes.Point2D;
import laba2.util.math.geom.shapes.Polyline2D;
import laba2.util.math.geom.shapes.Rect2D;
import laba2.util.math.geom.shapes.TransformMatrix2D;
...
public class SVGGroupParser implements IGroupParser {
	...
	/**
	 * Parses a given string as a number. The valid format of the number is specified in the SVG standard. It is parsed through the regular expression {@code
	 * NUMBER_PATTERN}.
	 *
