package laba2.util.math.geom.shapes;
 ...
 * See <a href="https://www.w3.org/TR/SVG/coords.html#TransformMatrixDefined">w3c&reg; SVG TransformMatrix definition</a>
 * for more information about these matrices.
 *
...
public class TransformMatrix2D {
	...
	public TransformMatrix2D multiply(TransformMatrix2D matrix) {
		return new TransformMatrix2D(a * matrix.a + c * matrix.b, b * matrix.a + d * matrix.b, a * matrix.c + c * matrix.d, b * matrix.c + d * matrix.d,
	...
	public TransformMatrix2D inverse() {
		...
		return new TransformMatrix2D(d / determinant, -b / determinant, -c / determinant, a / determinant, (c * f - d * e) / determinant,
				(b * e - a * f) / determinant);
	}
	...
	public boolean equals(TransformMatrix2D op2) {
		...
		return Util.compareDoubles(this.a, op2.a) && Util.compareDoubles(this.b, op2.b) && Util.compareDoubles(this.c, op2.c) && Util.compareDoubles(this.d,
				op2.d) && Util.compareDoubles(this.e, op2.e) && Util.compareDoubles(this.f, op2.f);
	}
