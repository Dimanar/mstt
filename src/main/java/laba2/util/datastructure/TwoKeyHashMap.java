package laba2.util.datastructure;
...
public class TwoKeyHashMap<K1, K2, V> extends HashMap<Pair<K1, K2>, V> {
	 ...
	 * value is replaced.
	 *
	 * @param key1 the first key of the key pair, with which the specified value
	 * is to be associated.
	 * @param key2 the second key of the key pair, with which the specified value
	 * is to be associated.
	 ...
	 * cases.
	 *
	 * @param key1 the first key of the key pair, whose associated value is to be
	 * returned.
	 * @param key2 the second key of the key pair, whose associated value is to
	 * be returned.
	 ...
	 * specified key pair.
	 *
	 * @param key1 the first key of the key pair whose presence in this map is to
	 * be tested.
	 * @param key2 the second key of the key pair whose presence in this map is
	 * to be tested.
	 ...
	 *
	 * @param key1 the first key of the key pair, whose mapping is to be removed
	 * from the map.
	 * @param key2 the second key of the key pair, whose mapping is to be removed
	 * from the map.
