...
public class Table<RowHeaderType, ColumnHeaderType, ValueType> {
	 ...
	 *
	 * @param rowHeaders a list of row headers
	 ...
	 * @param v the value
	 * @throws NullPointerException if the row, column, or value is <code>null</code>.
	 */
	 ...
	 * table.
	 *
	 * @param r a row in the table
	 * @param c a column in the table
	 ...
	 * @throws NullPointerException if the row or column is <code>null</code>.
	 */
