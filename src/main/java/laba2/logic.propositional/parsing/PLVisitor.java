package laba2.logic.propositional.parsing;
 ...
 * @param <R> the return type to be returned from the visitor methods.
 * @author Ravi Mohan
...
public interface PLVisitor<A, R> {
	 ...
	 *
	 * @param sentence a Sentence that is a propositional symbol.
	 * @param arg optional argument to be used by the visitor.
	 ...
	 *
	 * @param sentence a Sentence that is a unary complex sentence.
	 * @param arg optional argument to be used by the visitor.
	 * @return optional return value to be used by the visitor.
	 */
	 ...
	 *
	 * @param sentence a Sentence that is a binary complex sentence.
	 * @param arg optional argument to be used by the visitor.
	 * @return optional return value to be used by the visitor.
	 */
