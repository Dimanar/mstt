package laba2.logic.propositional.parsing.ast;

import java.util.Arrays;
import java.util.List;

import laba2.logic.common.ParseTreeNode;
import laba2.logic.propositional.parsing.PLVisitor;
...
public abstract class Sentence implements ParseTreeNode {
	 ...
	 *
	 * @param disjuncts the disjuncts from which to create the disjunction.
	 ...
	 *
	 * @param conjuncts the conjuncts from which to create the conjunction.
	 ...
	 *
	 * @param offset the offset of the contained simplified sentence to retrieve.
	 ...
	 * Sentence.
	 *
	 * @param plv a Propositional Logic visitor.
	 * @param arg an optional argument for use by the visior.
	 ...
	 *
	 * @param parentConnective the connective of the parent sentence.
	 * @param childSentence a simpler child sentence.
