...
public enum Connective {
	 ...
	 *
	 * @param symbol a symbol to be tested whether or not is represents a
	 * connective.
	 ...
	 *
	 * @param symbol a symbol for which a corresponding connective is wanted.
	 * @return the connective associated with a given symbol.
	 * @throws IllegalArgumentException if a connective cannot be found that matches the given
	 * symbol.
	 */
