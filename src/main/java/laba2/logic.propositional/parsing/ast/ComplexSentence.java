...
public class ComplexSentence extends Sentence {
	 ...
	 * Constructor.
	 *
	 * @param connective the complex sentence's connective.
	 * @param sentences the simpler sentences making up the complex sentence.
	 */
	 ...
	 *
	 * @param sentenceL the left hand sentence.
	 * @param binaryConnective the binary connective.
	 * @param sentenceR the right hand sentence.
	 */
