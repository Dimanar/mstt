package laba2.logic.propositional.transformations;
...
public class ClauseCollector extends BasicGatherer<Clause> {
	 ...
	 *
	 * @param cnfSentences a list of CNF sentences from which to collect clauses.
	 * @return a set of all contained clauses.
	 * @throws IllegalArgumentException if any of the given sentences are not in CNF.
	 */
