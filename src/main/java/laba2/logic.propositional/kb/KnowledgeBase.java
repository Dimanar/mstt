package laba2.logic.propositional.kb;
...
import laba2.logic.propositional.inference.TTEntails;
import laba2.logic.propositional.kb.data.Clause;
import laba2.logic.propositional.kb.data.ConjunctionOfClauses;
import laba2.logic.propositional.parsing.PLParser;
...
public class KnowledgeBase {
	 ...
	 *
	 * @param aSentence a fact to be added to the knowledge base.
	 */
	 ...
	 * it perceives.
	 *
	 * @param percepts what the agent perceives
	 */
	 ...
	 * algorithm.
	 *
	 * @param queryString a question to ASK the knowledge base
