...
public class ConjunctionOfClauses {
	 ...
	 * Constructor.
	 *
	 * @param conjunctionOfClauses a collection of clauses that represent a conjunction.
	 */
	 ...
	 *
	 * @param additionalClauses the additional clauses to be added to the existing set of
