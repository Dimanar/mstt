package laba2.logic.propositional.agent;
...
public abstract class KBAgent<P, A> extends SimpleAgent<P, A> {
	 ...
	 *
	 * @param percept the given percept
	 ...
	 *
	 * @param action the chose action.
	 * @param t the time at which the action was executed.
	 ...
	 *
	 * @param kb the KB to ask.
	 * @param actionQuery an action query.
