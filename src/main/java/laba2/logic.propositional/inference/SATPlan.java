...
public class SATPlan {
	 ...
	 *
	 * @param init provides a collection of assertions about the initial state.
	 * @param transition provides the successor-state axioms for all possible actions
	 * at each time step up to some maximum t.
	 * @param goal provides the assertion that the goal is achieved at time t.
	 * @param tMax the maximum number of time steps in which the goal is to be
	 * achieved in.
