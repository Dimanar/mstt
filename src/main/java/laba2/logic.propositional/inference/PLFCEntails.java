...
public class PLFCEntails {
	 ...
	 *
	 * @param kb the knowledge base, a set of propositional definite clauses.
	 * @param q q, the query, a proposition symbol
	 * @return true if KB |= q, false otherwise.
	 * @throws IllegalArgumentException if KB contains any non-definite clauses.
	 */
