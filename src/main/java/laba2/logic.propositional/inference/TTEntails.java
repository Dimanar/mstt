...
public class TTEntails implements EntailmentChecker {
	 ...
	 * function TT-ENTAILS?(KB, &alpha;) returns true or false.
	 *
	 * @param kb KB, the knowledge base, a sentence in propositional logic
	 * @param alpha &alpha;, the query, a sentence in propositional logic
	 ...
	 * @param kb KB, the knowledge base, a sentence in propositional logic
	 * @param alpha &alpha;, the query, a sentence in propositional logic
	 * @param symbols a list of currently unassigned propositional symbols in the
	 * model.
	 * @param model a partially or fully assigned model for the given KB and
	 * query.
	 * @return true if KB entails &alpha;, false otherwise.
	 */
