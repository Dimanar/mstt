package laba2.probability.bayes.approx;

import java.util.LinkedHashMap;
import java.util.Map;

import laba2.probability.FiniteProbabilityModel;
import laba2.probability.RandomVariable;
import laba2.probability.bayes.DynamicBayesianNetwork;
import laba2.probability.bayes.exact.EliminationAsk;
import laba2.probability.bayes.model.FiniteBayesModel;
import laba2.probability.domain.FiniteIntegerDomain;
import laba2.probability.proposition.AssignmentProposition;
import laba2.probability.util.ProbUtil;
import laba2.probability.util.RandVar;
import laba2.util.JavaRandomizer;
...
public class ParticleFiltering {
	 ...
	 *
	 * @param N the number of samples to be maintained
	 * @param dbn a DBN with prior <b>P</b>(<b>X</b><sub>0</sub>), transition
	 ...
	 * sensor model <b>P</b>(<b>E</b><sub>1</sub> |
	 * <b>X</b><sub>1</sub>)
	 * @param randomizer a Randomizer to be used for sampling purposes.
	 */
	public ParticleFiltering(int N, DynamicBayesianNetwork dbn,
	 ...
	 *
	 * @param e <b>e</b>, the new incoming evidence
