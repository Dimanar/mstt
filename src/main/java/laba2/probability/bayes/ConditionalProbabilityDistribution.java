package laba2.probability.bayes;

import java.util.Set;

import laba2.probability.ProbabilityDistribution;
...
public interface ConditionalProbabilityDistribution {
	...
	/**
	 * @param rv the Random Variable to be checked.
	 ...
	 *
	 * @param eventValues the values for the random variables comprising the Conditional
	 * Distribution
	 ...
	 *
	 * @param parentValues for the conditioning case. The ordering and size of
	 ...
	 * set of cases for the random variable.
	 *
	 * @param parentValues for the conditioning case. The size of parentValues must equal
	 ...
	 * distribution is on.
	 *
	 * @param probabilityChoice a double value, from the range [0.0d, 1.0d), i.e. 0.0d
