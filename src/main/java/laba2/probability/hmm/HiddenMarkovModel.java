...
public interface HiddenMarkovModel {
	 ...
	 *
	 * @param evidence the evidence assignment e.
	 ...
	 *
	 * @param fromCD the categorical distribution to be converted.
	 ...
	 *
	 * @param fromMessage the column vector in Matrix form to be converted.
	 ...
	 *
	 * @param matrixs the column vectors in matrix form to be converted.
	 ...
	 * vector.
	 *
	 * @param m a column vector representation in matrix form.
