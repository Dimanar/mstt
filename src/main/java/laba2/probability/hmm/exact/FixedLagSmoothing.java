package laba2.probability.hmm.exact;
...
public class FixedLagSmoothing {
	 ...
	 * persistent values.
	 *
	 * @param hmm a hidden Markov model with S * S transition matrix <b>T</b>
	 * @param d d, the length of the lag for smoothing
	 */
	 ...
	 *
	 * @param et the current evidence from time step t
	 ...
	 * </pre>
	 *
	 * @param f1_t <b>f</b><sub>1:t</sub>
	 * @param O_tp1 <b>O</b><sub>t+1</sub>
