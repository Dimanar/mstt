package laba2.probability.temporal.generic;
...
import laba2.probability.temporal.ForwardBackwardInference;
...
public class ForwardBackward implements ForwardBackwardInference {
	 ...
	 *
	 * @param transitionModel the transition model.
	 * @param tToTm1StateVarMap a map from the X<sub>t<sub> random variables in the transition
